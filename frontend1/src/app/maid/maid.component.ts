...
export class MaidComponent implements OnInit {
  ...
  process()
{
  alert(JSON.stringify({startdate:this.earriveprop,enddate:this.arriveprop,time:this.timeprop,shtime:this.ttimeprop,demand:this.demandprop,people:this.peopleprop}));
